...
- [x] Implementar 6 Métodos CRUD:
    ...
    - [x] delete(id) - Deletar.
- [ ] Validação:
    - [ ] Testar todas as rotas no Insomnia.
    - [ ] Tirar Prints dos testes de Categoria.
- [ ] Git: add, commit e push da branch atual.
...
- [ ] Criar Módulo Produto:
    - [ ] Entity Produto (Atributos: id, nome, descricao, quantidade, preco, foto).
    - [ ] Module ProdutoModule.
    - [ ] Service ProdutoService.
    - [ ] Controller ProdutoController.
- [ ] Implementar Relacionamento (1:N Bidirecional):
    - [ ] Adicionar @ManyToOne na Entity Produto (Muitos produtos -> Uma Categoria).
    - [ ] Adicionar @OneToMany na Entity Categoria (Uma Categoria -> Muitos Produtos).
- [ ] Implementar 6 Métodos CRUD em Produto:
    - [ ] findAll (incluindo a relação com categoria).
    - [ ] findById (incluindo a relação).
    - [ ] findByNome (busca por nome do produto).
    - [ ] create.
    - [ ] update.
    - [ ] delete.
- [ ] Validação:
